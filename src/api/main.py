...
app = FastAPI(
    title="Coding Agent",
    description="AI coding assistant that generates production-grade code from natural language specifications, understands codebase context, follows project conventions, and produces type-safe, tested implementations across multiple languages and frameworks.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
